...
class CareCompMujinEndPage extends StatefulWidget {
  const CareCompMujinEndPage({Key? key}) : super(key: key);

  @override
  _CareCompMujinEndPageState createState() => _CareCompMujinEndPageState();
}

class _CareCompMujinEndPageState extends State<CareCompMujinEndPage> {
  int? selectIndex;
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              padding: const EdgeInsets.symmetric(horizontal: spacing_xl),
              alignment: Alignment.centerLeft,
              child: Text('Plinic 서비스를 이용하시면서 불편하셨던 경험이 있으시면 작성해주세요.',
                  style: TextStyle(
                    fontFamily: 'NotoSansKR',
                    color: black,
                    fontSize: 16,
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: '예) 회원가입 시 바우만 테스트가 너무 많다',
                    hintStyle: TextStyle(
                      fontFamily: 'NotoSansKR',
                      color: textfields,
                      fontSize: 12,
