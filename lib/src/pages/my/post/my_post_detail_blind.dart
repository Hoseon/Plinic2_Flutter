...
import 'package:plinic2/src/component/plinic_dialog_blind_one_button.dart';
import 'package:readmore/readmore.dart';

class MyPostDetailBlindPage extends StatelessWidget {
  final bool isBlind = false;
  const MyPostDetailBlindPage({Key? key, isBlind}) : super(key: key);
      ...
      onTap: () async{
        ...
        await showAnimatedDialog(
                      ...
                      builder: (BuildContext context) {
                        return PlinicDialogBlindOneButton(
                          buttonText: '확인',
                          title: '알림',
                          content: '관리자에 의해\n게시물이 블라인드 처리 되었습니다.',
                          reason: '부적절한 게시물을 등록하여\n블라인드 처리 되었습니다.',
                          buttonClick: (){
                            Get.back();
                          },
                        );
  ...
  Widget inputComment() {
    return Container(
      ...
      // margin: EdgeInsets.only(left: 24, right: 40),
      color: Colors.transparent,
      child: TextField(
