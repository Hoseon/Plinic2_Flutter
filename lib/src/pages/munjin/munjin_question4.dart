...
import 'package:plinic2/src/pages/munjin/munjin_question5.dart';

class MunjinQuestion4Page extends StatefulWidget {
  const MunjinQuestion4Page({Key? key}) : super(key: key);

  @override
  _MunjinQuestion4PageState createState() => _MunjinQuestion4PageState();
}

class _MunjinQuestion4PageState extends State<MunjinQuestion4Page> {
  int? selectIndex;
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              alignment: Alignment.centerLeft,
              child: Text(
                  '화장품, 자외선차단제, 피부관리용 제품을 사용한 후에 피부의 발진, 가려움증, 따끔거리는 증상 등을 발생한 경험은?',
                  style: TextStyle(
                    fontFamily: 'NotoSansKR',
                    color: black,
                    fontSize: 16,
